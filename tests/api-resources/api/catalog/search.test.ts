...
describe('resource search', () => {
  ...
  test.skip('listProducts', async () => {
    const responsePromise = client.api.catalog.search.listProducts();
  ...
  test.skip('listProducts: request options and params are passed correctly', async () => {
    ...
    await expect(client.api.catalog.search.listProducts({
    id: 'id',
    adhoc: 'adhoc',
    limit: 0,
    page: 0,
  ...
  // Mock server tests are disabled
  test.skip('retrieveProduct', async () => {
    const responsePromise = client.api.catalog.search.retrieveProduct('productId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
