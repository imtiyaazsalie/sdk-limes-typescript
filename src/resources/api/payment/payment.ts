...
import {
  DynamicServiceInitializeParams,
  DynamicServiceRecurringParams,
...
import {
  Paystack,
  PaystackCancelSubscriptionParams,
  PaystackChargeParams,
  PaystackInitializeComboParams,
  PaystackInitializeParams,
  PaystackLinkTransactionParams,
  PaystackLinkTransactionToServicesParams,
  PaystackSubscribeParams,
  PaystackVerifyParams,
...
export class Payment extends APIResource {
  ...
  listTransactions(
    query: PaymentListTransactionsParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<void> {
    return this._client.get('/api/Payment/transactions', {
      query,
      ...options,
  ...
  refund(body: PaymentRefundParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/api/Payment/refund', {
      body,
      ...options,
      headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
    });
...
export declare namespace Payment {
  ...
  export { ComboBundle as ComboBundle, type ComboBundleRecurringParams as ComboBundleRecurringParams };
}
